...
### What It's NOT
- ❌ Not a manual repository (links to VinFast official resources)
- ❌ Not replacing VinFast support
...
├── index.html              ✓ Main site (bilingual EN/FR)
├── css/styles.css         ✓ Modern, responsive styling
├── js/main.js             ✓ Language toggle & smooth scroll
├── README.md              ✓ Complete documentation
├── DEPLOYMENT_GUIDE.md    ✓ How to deploy
├── BUG_TRACKING_SETUP.md  ✓ GitHub Issues integration
...
## 💼 Member Benefit Corporation Model
...
- **Domain**: $12-15/year
- **Payment**: % per transaction (Stripe: 2.9% + 30¢)
...
- ✅ Independent organization (clearly disclosed)
- ✅ Not affiliated with VinFast Auto
- ⚠️ Consider forming official nonprofit or benefit corp
- ⚠️ Need membership agreements (when launching paid tier)
- ⚠️ Privacy policy for member data
- ⚠️ Terms of service
- ⚠️ Consult lawyer before accepting payments
...
- ✅ Bilingual (EN/FR) like you wanted
- ✅ Owners club aesthetic (not just info site)
- ✅ Community platform links prominently featured
- ✅ Less focus on manuals/guides
- ✅ Membership & advocacy focused
- ✅ Future merch/benefits ready
